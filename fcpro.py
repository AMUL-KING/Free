...
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO MR. AMUL
...
def main():
	...
	print("\033[96;1m  [J] JOIN MR. AMUL GROUP \033[92;1m✘\033[91;1m✘")
...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/AMUL-KING/TERMUX-.git")
